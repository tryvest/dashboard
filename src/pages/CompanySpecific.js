                    ...
                    <Stack spacing={1}>
                      <div style={{ marginBottom: '15px' }}>
                        <Stack direction={'row'} justifyContent={'space-between'}>
                          <Typography fontSize={'28px'} fontWeight={'600'} color={'#fff'}>
                            You're Enrolled in {businessInfo.name}
                          </Typography>
                      ...
                      <Grid container spacing={1}>
                        ...
                        <Grid item>
                          ...
                          >
                            <Typography>Equity Earned</Typography>
                            <Typography color={theme.palette.primary.main}>
                      ...
                      <Stack justifyContent={"space-between"} alignItems={"center"} color={"white"} direction={"row"}>
                        <Stack>
                          <Typography>
                            Current Campaign Ends On:
                          </Typography>
                          <Typography color={"lightgrey"}>
                            {`${new Date(businessCampaignInfo?.endDate)}`}
                          </Typography>
                          <Typography>
                            You can withdraw your investment up until 48 hours before then.
                          </Typography>
                        </Stack>
